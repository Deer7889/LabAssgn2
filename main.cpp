...
int term_1, term_2; //define integers named term_1 and term_2     
int next_term = 0;  //define and set integer next_term to 0
...
int main() {        //start main program using a simple for loop
    ...
    printf("0, 1, ");                                     //print 0,1 always for sequence start
        for(int i = 2; i<nth_term;i++) {  //start for loop, if set i to 0, check if under 9, increase by 1
